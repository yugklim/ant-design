...
## 3.6.0
`2018-06-02`
* 🌟 `Form`'s error message now can be customized with react element [#10136](https://github.com/ant-design/ant-design/issues/10136) [@lovekonakona](https://github.com/lovekonakona)
...
* 🐞 Fix offsetBottom causing `Affix` not 'fixed-able' [#10674](https://github.com/ant-design/ant-design/issues/10674)
